...
public class R {
    ...
    /**
     * Obtiene una {@code URL} para la hoja de estilos ubicada en su directorio.
     *
     * @param name el nombre de la hoja de estilos a obtener.
     * @return una {@code URL} que representa el recurso solicitado,
     * o {@code null} si no se encuentra el recurso.
     */
    public static URL getStyles(String name) {
